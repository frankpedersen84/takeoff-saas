...
export default function ApiKeyModal({ onClose }) {
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[2000]">
      <div className="bg-level-2 rounded-2xl p-8 w-full max-w-lg border border-gray-700">
        ...
        <div className="bg-level-1 rounded-lg p-4 mb-6">
          <h3 className="text-sm font-semibold text-gold mb-2">Server Configuration</h3>
          <p className="text-gray-400 text-sm mb-3">
            Set your Anthropic API key in the server's <code className="bg-level-2 px-2 py-1 rounded">.env</code> file:
          </p>
          <code className="block bg-level-2 p-3 rounded text-sm font-mono text-teal">
